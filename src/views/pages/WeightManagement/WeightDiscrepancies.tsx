...
import WeightDiscreppanciesTableHeader from '../apps/invoice/list/WeightMAnagementTableHeader/WeightDiscreppanciesTableHeader'
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <WeightDiscreppanciesTableHeader value={value} selectedRows={selectedRows} handleFilter={handleFilter} />
            <DataGrid
              autoHeight
              pagination
              rowHeight={62}
