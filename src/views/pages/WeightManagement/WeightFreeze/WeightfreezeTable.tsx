...
import WeightFreezeTableHeader from '../../apps/invoice/list/WeightMAnagementTableHeader/WeightFreezeTableHeader'
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <WeightFreezeTableHeader value={value} selectedRows={selectedRows} handleFilter={handleFilter} />
            <DataGrid
              autoHeight
              pagination
              rowHeight={62}
