...
import TableHeader from '../apps/invoice/list/TableHeader'
import ReturnTableHeader from '../apps/invoice/list/ReturnTableHeaders/ReturnTableHeader'
import NDRTableHeader from '../apps/invoice/list/NDRTableHeaders/NDRTableHeader'
...
const defaultColumns: GridColDef[] = [
  ...
  {
    flex: 0.1,
    field: 'Field Executive Info',
    minWidth: 100,
    headerName: 'Field Executive Info',
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <NDRTableHeader value={value} selectedRows={selectedRows} handleFilter={handleFilter} />
            <DataGrid
              autoHeight
              pagination
              rowHeight={62}
