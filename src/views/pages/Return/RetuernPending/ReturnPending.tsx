...
import ReturnPendingTableHeader from '../../apps/invoice/list/ReturnTableHeaders/ReturnPendingTableHeader'
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <ReturnPendingTableHeader value={value} selectedRows={selectedRows} handleFilter={handleFilter} />
            <DataGrid
              autoHeight
              pagination
              rowHeight={62}
