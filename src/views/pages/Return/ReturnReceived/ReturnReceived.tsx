...
import ReturnTableHeader from '../../apps/invoice/list/ReturnTableHeaders/ReturnTableHeader'
import NewReturnTableHeader from '../../apps/invoice/list/ReturnTableHeaders/NewReturnTableHeader'
import InTransitTableHeader from '../../apps/invoice/list/ReturnTableHeaders/InTransitTableHeader'
...
const defaultColumns: GridColDef[] = [
  ...
  },
  {
    ...
    renderCell: ({ row }: CellType) => <Typography sx={{ color: 'text.secondary' }}>{row.balance}</Typography>
  },
  {
    flex: 0.1,
    minWidth: 100,
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <InTransitTableHeader value={value} selectedRows={selectedRows} handleFilter={handleFilter} />
            <DataGrid
              autoHeight
              pagination
              rowHeight={62}
