...
import TableHeaderReadytoShip from '../../apps/invoice/list/TableHeaderReadytoShip'
import TableHeaderPickups from '../../apps/invoice/list/TableHeaderPickups'
...
const defaultColumns: GridColDef[] = [
  {
    ...
    minWidth: 80,
    field: 'invoiceStatus',
    headerName: 'Pickup ID / Pickup Request Date',
  ...
  },
  {
    ...
    minWidth: 140,
    field: 'address',
    headerName: 'Pickup / RTO Addresses  ',
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <TableHeaderPickups value={value} selectedRows={selectedRows} handleFilter={handleFilter} />
            <DataGrid
              autoHeight
              pagination
              rowHeight={62}
