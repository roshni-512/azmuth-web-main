...
import TableHeaderInTransit from '../../apps/invoice/list/TableHeaderInTransit'
import TableHeaderDelivered from '../../apps/invoice/list/TableHeaderDelivered'
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <TableHeaderDelivered value={value} selectedRows={selectedRows} handleFilter={handleFilter} />
            <DataGrid
              autoHeight
              pagination
              rowHeight={62}
